...
async function parseAndExtractData(val: UploadFile[] | ArrayBuffer | string) {
  console.log("val's value type:", typeof val, "value===>>", val)
  templateData.value = null
  importData.value = null
  importColumns.value = []
  try {
    console.log("isWorkerSupport in QuickImport:"+ isWorkerSupport)
        console.log("importWorker in QuickImport:" + importWorker)
    ...
    if (isWorkerSupport && importWorker) {
      ...
      console.log("importColumns.value====>>>", importColumns.value)
